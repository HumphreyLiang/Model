...
<!-- Custom Fonts -->
<link href="<%=request.getContextPath()%>/front_end/font-awesome/css/font-awesome.min.css" rel="stylesheet"
	type="text/css">
	...
	<header id="myCarousel" class="carousel slide">
		...
		<div class="carousel-inner">
			<div class="item active">
				<div class="fill"
					style="background-image: url('<%=request.getContextPath()%>/front_end/images/pets_try1.jpg');"></div>
			...
			<div class="item">
				<div class="fill"
					style="background-image: url('<%=request.getContextPath()%>/front_end/images/restaurant.jpg');"></div>
				<div class="carousel-caption">
					<h2>Caption 2</h2>
				</div>
			</div>
			<div class="item">
				<div class="fill"
					style="background-image: url('<%=request.getContextPath()%>/front_end/images/pets_try3_resized.jpg');"></div>
				<div class="carousel-caption">
					<h2>Caption 3</h2>
				</div>
			</div>
					...
					<div id="sites">
						<span class="add-border display-block"> <input type="radio"
							...
							for="girl-button" class="selected"><img
								src="<%=request.getContextPath()%>/front_end/images/girl.png" alt="" /></label> <input type="radio"
							name="site1" id="man-button" value="man" /> <label
							for="man-button"><img src="<%=request.getContextPath()%>/front_end/images/man.png" alt="" /></label>
							...
							checked="checked" /> <label for="dog-button" class="selected"><img
								src="<%=request.getContextPath()%>/front_end/images/dog.png" alt="" /></label> <input type="radio" name="site2"
							id="cat-button" value="cat" /> <label for="cat-button"><img
								src="<%=request.getContextPath()%>/front_end/images/cat.png" alt="" /></label>
						</span>
					</div>
				</li>
				<li>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-7 item-margin-lg">
					<a href="date.html"> <img
						...
						src="<%=request.getContextPath()%>/front_end/images/WP14-750x400.jpg" alt="">
					</a>
				</div>
				...
				<div class="col-xs-12 col-sm-7 item-margin-lg col-sm-pull-5">
					<a href="product.html"> <img
						class="adjust-size img-rounded img-responsive img-portfolio img-hover"
						src="<%=request.getContextPath()%>/front_end/images/WP7-750x400.jpg" alt="">
					</a>
				</div>
				<div class="text-center col-xs-12 col-sm-5 item-margin-lg">
				...
				<div class="col-xs-12 col-sm-7 item-margin-lg">
					<a href="activity.html"> <img
						class="adjust-size img-rounded img-responsive img-portfolio img-hover"
						src="<%=request.getContextPath()%>/front_end/images/WP15-700x450.jpg" alt="">
					</a>
				</div>
				<div
				...
				<div class="col-xs-12 col-sm-7 item-margin-lg col-sm-pull-5">
					<a href="diary.html"> <img
						class="adjust-size img-rounded img-responsive img-portfolio img-hover"
						src="<%=request.getContextPath()%>/front_end/images/WP17-750x400.jpg" alt="">
					</a>
				</div>
			</div>
		</div>
