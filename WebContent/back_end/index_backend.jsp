						...
						<c:if test="<%=(((List) pageContext.getAttribute(\"auth\")) != null)%>">
							...
							<c:if
								...
								<div id="sm4" class="sublinks collapse">
									<a href="<%=request.getContextPath()%>/back_end/apprec/index_report.jsp" class="list-group-item small"> 約會商品檢舉管理</a> <a
							...
							<c:if
								...
								<a href="<%=request.getContextPath()%>/back_end/letter/index_letter.jsp" class="list-group-item">管站內信管理</a>
							</c:if>
